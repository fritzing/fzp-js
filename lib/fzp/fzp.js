...
var FZP = function () {
  ...
  _createClass(FZP, [{
    ...
    key: 'loadSVGs',
    value: function loadSVGs() {
      var _this = this;

      return this.views.breadboard.loadSVG().then(function (d) {
        return _this.views.schematic.loadSVG().then(function (d) {
          return _this.views.pcb.loadSVG().then(function (d) {
            return d;
          });
        });
      });
